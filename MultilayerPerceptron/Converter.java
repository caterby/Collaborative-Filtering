...
public class Converter {
    ...
    private static final String COMMENTS = "% Title: SPAM/HAM data sets\n" +
            "% \n" +
            "% \n";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Has converted the .zip file into ARFF file");
        System.out.println("The ARFF files are in the " + ARFF_DIR + " folder!");
    }
